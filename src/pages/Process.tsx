...
const Process = () => {
  ...
  const pulseVariants = {
    initial: { scale: 1, boxShadow: "0 0 0 0 rgba(255, 215, 0, 0.7)" },
    pulse: {
      scale: [1, 1.05, 1],
      boxShadow: [
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold mb-8">
              Our <span className="text-yellow-500 drop-shadow-[0_0_20px_#FFD700]">Process</span>
            </h1>
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          >
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 md:mb-8">
              Our Process: <span className="text-yellow-500 drop-shadow-[0_0_20px_#FFD700]">Clear & Effective</span>
            </h2>
          ...
          >
            ...
            <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-yellow-500/50 via-yellow-500/30 to-transparent"></div>
              ...
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <div className="flex justify-center md:absolute md:left-1/2 md:transform md:-translate-x-1/2 z-10 mb-6 md:mb-0">
                    <motion.div
                      className="w-16 h-16 bg-yellow-500 rounded-full flex items-center justify-center text-black font-bold text-2xl shadow-[0_0_30px_rgba(255,215,0,0.5)]"
                  ...
                  <div className={`w-full md:w-5/12 ${index % 2 === 0 ? 'md:pr-12' : 'md:pl-12'} px-4 md:px-0`}>
                    <motion.div 
                      className="bg-black/60 backdrop-blur-sm border border-gray-800/50 rounded-2xl p-6 md:p-8 hover:border-yellow-500/50 transition-all duration-500 group hover:shadow-[0_0_40px_rgba(255,215,0,0.1)]"
                    ...
                    >
                      ...
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                        <div className="text-center md:text-left mb-4 md:mb-0">
                          ...
                          <div className="flex items-center justify-center md:justify-start space-x-2">
                            ...
                            <span className="text-yellow-500 font-semibold">{step.duration}</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4">
                        <div className="flex items-start space-x-3">
                          <step.proofIcon className="w-5 h-5 text-yellow-500 mt-0.5 flex-shrink-0" />
                  ...
                  <div className={`hidden md:flex justify-center mt-6 md:mt-0 md:w-[55%] ${index % 2 === 0 ? 'md:pl-8' : 'md:pr-8'}`}>
                    <motion.div
                      className="w-20 h-20 md:w-24 md:h-24 bg-yellow-500/10 border border-yellow-500/30 rounded-2xl flex items-center justify-center backdrop-blur-sm"
                    ...
                    >
                      <step.icon className="w-10 h-10 md:w-12 md:h-12 text-yellow-500" />
                    </motion.div>
                  </div>
                </motion.div>
              ))}
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <div className="bg-black/50 border border-yellow-500/30 rounded-2xl p-6 md:p-8 max-w-4xl mx-auto">
                ...
                <button className="w-full md:w-auto px-6 md:px-8 py-3 md:py-4 bg-yellow-500 text-black font-bold text-base md:text-lg rounded-lg hover:bg-yellow-400 hover:drop-shadow-[0_0_20px_#FFD700] transition-all duration-300 transform hover:scale-105">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {differentiators.map((item, index) => (
              <motion.div
                ...
                className="bg-gray-900/50 border border-gray-800 rounded-lg p-6 md:p-8 hover:border-yellow-500/50 transition-all duration-300 group"
              >
                <div className="relative">
                  ...
                  <div className="pl-4 md:pl-6">
                    <item.icon className="w-10 h-10 md:w-12 md:h-12 text-yellow-500 mb-4 md:mb-6 group-hover:drop-shadow-[0_0_15px_#FFD700] transition-all duration-300" />
      ...
      <section className="py-12 md:py-20 px-4 md:px-6 bg-gray-900/30">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <div className="relative bg-gray-900/50 backdrop-blur-sm border border-yellow-500/30 rounded-2xl p-6 md:p-12">
              ...
              <a
                href="/contact"
                className="inline-block w-full md:w-auto px-6 md:px-8 py-3 md:py-4 bg-yellow-500 text-black font-bold text-base md:text-lg rounded-lg hover:bg-yellow-400 hover:drop-shadow-[0_0_20px_#FFD700] transition-all duration-300 transform hover:scale-105"
              >
